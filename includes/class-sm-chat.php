...
class Sm_Chat {
	 ...
	 *
	 * - Sm_Chat_Loader. Orchestrates the hooks of the plugin.
	 * - Sm_Chat_i18n. Defines internationalization functionality.
	 * - Sm_Chat_Admin. Defines all hooks for the admin area.
	 * - Sm_Chat_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Sm_Chat_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Sm_Chat_Loader    Orchestrates the hooks of the plugin.
	 */
